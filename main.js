	...
	function up(){
		...
		console.log("When up arrow key is preesed, x = " + greencar_x + " , y = " + greencar_y);
		uploadBackground();
		uploadgreencar();
...
function down()
{
	...
	if (greencar_y <= 700)
	{
		...
		console.log("When down arrow key is preesed, x = " + greencar_x + " , y = " + greencar_y);
		uploadBackground();
		uploadgreencar();
	}
}
...
function left()
{
	...
	if (greencar_x >= 0)
	{
		...
		console.log("When left arrow key is preesed, x = " + greencar_x + " , y = " + greencar_y);
		uploadBackground();
		uploadgreencar();
	}
}
...
function right()
{
	...
	if (greencar_x <= 500)
	{
		...
		console.log("When right arrow key is preesed, x = " + greencar_x + " , y = " + greencar_y);
		uploadBackground();
		uploadgreencar();
	}
}}
